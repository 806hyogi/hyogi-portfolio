    ...
    return (
        <button
            ...
            className={cn(
                ...
                variant === "outline" &&
                "border border-slate-300 text-zinc-900 hover:bg-slate-50 dark:border-slate-700 dark:text-zinc-100 dark:hover:bg-slate-800",
                variant === "ghost" &&
                "text-zinc-900 hover:bg-slate-100 dark:text-zinc-100 dark:hover:bg-slate-800",
                className
            )}
        >
            <Download aria-hidden="true" className={compact ? "size-4" : "size-5"} />
            이력서
        </button>
    );
}
